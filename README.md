...
| **Frosted cards** | Every card is a translucent, frosted pane the weather shows through, not a coloured slab sitting on it. iOS uses a real material, which blurs its backdrop and turns opaque by itself under **Reduce Transparency**; Android uses translucency and a lit rim, because Compose has no backdrop blur below API 31 and this app supports 26. | ✅ Built |
